...
if __name__ == '__main__':
    ...
    parser.add_argument('--psi_start', type=int, default=50, help='psi of start')
    parser.add_argument('--x_end', type=int, default=90, help='X of end')
    parser.add_argument('--y_end', type=int, default=0, help='Y of end')
    parser.add_argument('--parking', type=int, default=4, help='park position in parking1 out of 24')
